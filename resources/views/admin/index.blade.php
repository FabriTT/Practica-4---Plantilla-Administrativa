...
<html dir="ltr" lang="en">
  <head>
    ...
    <link
      ...
      type="image/png"
      sizes="16x16"
      href="{{ asset('vendor/AdminMatrix/assets/images/favicon.png') }}"
    />
    <!-- Custom CSS -->
    <link href="{{ asset('vendor/AdminMatrix/assets/libs/flot/css/float-chart.css') }}" rel="stylesheet" />
    <!-- Custom CSS -->
    <link href="{{ asset('vendor/AdminMatrix/dist/css/style.min.css') }}" rel="stylesheet" />
  ...
  <body>
          ...
          <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand" href="{{ route('index') }}">
              ...
              <b class="logo-icon ps-2">
                ...
                <!-- Dark Logo icon -->
                <img
                  src="{{ asset('vendor/AdminMatrix/assets/images/logo-icon.png') }}"
                  alt="homepage"
                  class="light-logo"
                  width="25"
                />
              ...
              <span class="logo-text ms-2">
                <!-- dark Logo text -->
                <img
                  src="{{ asset('vendor/AdminMatrix/assets/images/logo-text.png') }}"
                  alt="homepage"
                  class="light-logo"
                />
              </span>
              ...
              <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
              <!-- Dark Logo icon -->
              <!-- <img src="{{ asset('vendor/AdminMatrix/assets/images/logo-text.png" alt="homepage" class="light-logo') }}" /> -->
          ...
          >
            ...
            <ul class="navbar-nav float-end">
              ...
              <li class="nav-item dropdown">
                ...
                >
                  <img
                    src="{{ asset('vendor/AdminMatrix/assets/images/users/1.jpg') }}"
                    alt="user"
              ...
              <div class="card">
                ...
                <div class="comment-widgets scrollable">
                  ...
                  <div class="d-flex flex-row comment-row">
                    <div class="p-2">
                      <img
                        src="{{ asset('vendor/AdminMatrix/assets/images/users/4.jpg') }}"
                        alt="user"
                        width="50"
                        class="rounded-circle"
                      />
                  ...
                  <div class="d-flex flex-row comment-row">
                    <div class="p-2">
                      <img
                        src="{{ asset('vendor/AdminMatrix/assets/images/users/5.jpg') }}"
                        alt="user"
                        width="50"
                        class="rounded-circle"
                      />
                        ...
                        <ul class="list-style-none assignedto">
                          ...
                          <li class="assignee">
                            <img
                              class="rounded-circle"
                              width="40"
                              src="{{ asset('vendor/AdminMatrix/assets/images/users/2.jpg') }}"
                              alt="user"
                              data-toggle="tooltip"
                              data-placement="top"
                              title=""
                          ...
                          <li class="assignee">
                            <img
                              class="rounded-circle"
                              width="40"
                              src="{{ asset('vendor/AdminMatrix/assets/images/users/3.jpg') }}"
                              alt="user"
                              data-toggle="tooltip"
                              data-placement="top"
                              title=""
                ...
                <div class="card-body">
                  ...
                  <div class="chat-box scrollable" style="height: 475px">
                    ...
                    <ul class="chat-list">
                      ...
                      <li class="chat-item">
                        <div class="chat-img">
                          <img src="{{ asset('vendor/AdminMatrix/assets/images/users/1.jpg') }}" alt="user" />
                        </div>
                      ...
                      <li class="chat-item">
                        <div class="chat-img">
                          <img src="{{ asset('vendor/AdminMatrix/assets/images/users/2.jpg') }}" alt="user" />
                        </div>
                        <div class="chat-content">
                      ...
                      <li class="chat-item">
                        <div class="chat-img">
                          <img src="{{ asset('vendor/AdminMatrix/assets/images/users/3.jpg') }}" alt="user" />
                        </div>
                        <div class="chat-content">
                ...
                <div class="tab-content tabcontent-border">
                  <div class="tab-pane active" id="home" role="tabpanel">
                    <div class="p-20">
                      ...
                      <img
                        src="{{ asset('vendor/AdminMatrix/assets/images/background/img4.jpg') }}"
                        class="img-fluid"
                      />
                    </div>
                  </div>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="{{ asset('vendor/AdminMatrix/assets/libs/jquery/dist/jquery.min.js') }}"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="{{ asset('vendor/AdminMatrix/assets/libs/bootstrap/dist/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('vendor/AdminMatrix/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js') }}"></script>
    <script src="{{ asset('vendor/AdminMatrix/assets/extra-libs/sparkline/sparkline.js') }}"></script>
    <!--Wave Effects -->
    <script src="{{ asset('vendor/AdminMatrix/dist/js/waves.js') }}"></script>
    <!--Menu sidebar -->
    <script src="{{ asset('vendor/AdminMatrix/dist/js/sidebarmenu.js') }}"></script>
    <!--Custom JavaScript -->
    <script src="{{ asset('vendor/AdminMatrix/dist/js/custom.min.js') }}"></script>
    <!--This page JavaScript -->
    <!-- <script src="{{ asset('vendor/AdminMatrix/dist/js/pages/dashboards/dashboard1.js') }}"></script> -->
    <!-- Charts js Files -->
    <script src="{{ asset('vendor/AdminMatrix/assets/libs/flot/excanvas.js') }}"></script>
    <script src="{{ asset('vendor/AdminMatrix/assets/libs/flot/jquery.flot.js') }}"></script>
    <script src="{{ asset('vendor/AdminMatrix/assets/libs/flot/jquery.flot.pie.js') }}"></script>
    <script src="{{ asset('vendor/AdminMatrix/assets/libs/flot/jquery.flot.time.js') }}"></script>
    <script src="{{ asset('vendor/AdminMatrix/assets/libs/flot/jquery.flot.stack.js') }}"></script>
    <script src="{{ asset('vendor/AdminMatrix/assets/libs/flot/jquery.flot.crosshair.js') }}"></script>
    <script src="{{ asset('vendor/AdminMatrix/assets/libs/flot.tooltip/js/jquery.flot.tooltip.min.js') }}"></script>
    <script src="{{ asset('vendor/AdminMatrix/dist/js/pages/chart/chart-page-init.js') }}"></script>
  </body>
</html>
